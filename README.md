...
This work is broken into three notebooks.  The first notebook includes the web scraper.  The second notebook has the bulk of the analysis.  The third notebook includes my initial foray into network analysis.
